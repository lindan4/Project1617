 ...
 */
public class ChecklistRequestNotificationHelper
{
    ...
    public ChecklistRequestNotificationHelper(Context context, String title, ArrayList<String> requestChecklist)
    {
        this.setContext(context);
        this.setTitle(title);


        this.setCheckListItemsAsString(checkListItemsAsString);
        this.setCheckListItemsArrayList(requestChecklist);
    ...
    public void inflate()
    {
        MaterialDialog requestNotificationDialog = new MaterialDialog.Builder(context)
                .titleColor(this.getContext().getResources().getColor(R.color.flashIt_red))
                .positiveText(ACCEPT)
